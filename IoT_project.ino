...
BLYNK_WRITE(V4)
{
  ...
  if(value == 1 && chk == true)
  {
    ...
    String requestURL = sheet_url + "Owner";
...
void loop() {
  ...
  if((content.substring(1) == "E3 C9 55 A7" || content.substring(1) == "C3 7B 71 A8" || content.substring(1) == "70 7D C2 1B" || content.substring(1) == "E3 09 43 A8" ) && chk == true){
